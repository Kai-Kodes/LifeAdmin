...
export default function DocumentForm({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-surface-900/50 p-4 backdrop-blur-sm animate-fadeIn">
      <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl sm:p-8 space-y-6">
        {/* Header */}
        ...
        {error && (
          <div className="rounded-xl border border-danger-200 bg-danger-50 p-3.5 flex items-center gap-2.5 text-sm text-danger-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* Document Name */}
          <div className="space-y-1.5">
            <label htmlFor="doc-name" className="block text-sm font-medium text-surface-700">
            ...
            <input
              ...
              disabled={isSubmitting}
              className="w-full rounded-xl border border-surface-200 px-4 py-2.5 text-sm text-surface-900 
          ...
          <div className="pt-2 border-t border-surface-100 space-y-4">
            ...
            {hasRenewalDate && (
              <div className="space-y-1.5 pl-7 animate-fadeIn">
                <label htmlFor="renewal-date" className="block text-xs font-medium text-surface-600">
                  Renewal Date
                </label>
                <input
                  id="renewal-date"
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-surface-100">
            <button
              ...
              onClick={onClose}
              disabled={isSubmitting}
              className="rounded-xl border border-surface-200 px-4 py-2.5 text-sm font-medium text-surface-600 
